...
namespace ClubeDaLeitura.ConsoleApp
{
    ...
    public class Emprestimo
    {
        ...
        {
            Console.WriteLine(" Regostro de devolução ");
            while (true)
            {
                try
                {
        ...
        #region Metodos FazerEmprestimo
            ...
            while (true)
            {
                ...
                for (int i = 0; i < contadorAmigos; i++)
                {
                    if (IdAmigo == i)
                    {
                        ...
                        {
                            aviso.ApresentarMensagem("OPA! Esse amigo tem uma revista não devolvida. Para fazer outro empréstimo é necessario fazer a devolução.", ConsoleColor.Red);
                            continue;
                        }
